          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              <Grid container spacing={2} mt={1}>
                <Grid item xs={6} sm={3}>
                  <Member name="Jeanne Barp" image={jeanne} />
                </Grid>
                <Grid item xs={6} sm={3} textAlign="center">
                  <Member name="Manon Ensuque" image={manon} />
                </Grid>
                <Grid item xs={6} sm={3}>
                  <Member name="Lucas Moriss" image={lucas} />
                </Grid>
                <Grid item xs={6} sm={3}>
                  <Member name="Morgane Paturel" image={morgane} />
                </Grid>
              </Grid>
            </Grid>
          </Grid>
